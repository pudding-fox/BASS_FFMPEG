...
DWORD BASSFFMPEGDEF(BASS_FFMPEG_GetTracks)(HSTREAM handle, FFMPEG_TRACK* tracks, DWORD count);

BOOL BASSFFMPEGDEF(BASS_FFMPEG_SetTrack)(HSTREAM handle, DWORD index);

DWORD BASSFFMPEGDEF(BASS_FFMPEG_GetTags)(HSTREAM handle, FFMPEG_TAG* tags, DWORD count);